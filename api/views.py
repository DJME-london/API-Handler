...
def song(request):
	...
	data3 = { 'Email': 'kohlivishrut@gmail.com'  , 'song1' : 'star boy' , 'song2' :  'dont let me down' , 'song3':'one time' , 'song4':'sugar' , 'song5':'kissing strangers' , 'song6':'closer'}
